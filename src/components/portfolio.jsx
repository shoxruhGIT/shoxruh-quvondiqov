  ...
  return (
    <div className="portfolio max-w-[1480px] m-auto pt-[50px] px-[75px] gap-[25px] pb-[20px]">
      <div class="flex flex-col gap-[10px] items-left">
        <div class="w-[400px] h-[210px] overflow-hidden px-[30px] pt-[60px] rounded-[10px] bg-slate-600">
          <img
            class="rounded-t-[10px] overflow-hidden"
            src={`https://portfolios-self.vercel.app/example-project.jpg`}
            alt=""
          />
        </div>
        <div class="flex items-center gap-[28px]">
          <h1 class="text-[20px] font-bold">Ninja sushi(fake)</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
        ...
        <h3 class="text-[20px] font-semibold text-left text-green-900">
          Next - Tailwind - Redux - MealDB API
        </h3>
        <p class="text-left text-[18px] w-[400px] font-normal">
      ...
      <div class="flex flex-col gap-[10px] items-left justify-center">
        <div class="w-[400px] h-[210px] overflow-hidden px-[30px] pt-[60px] rounded-[10px] bg-slate-600">
          <img
            class="rounded-t-[10px] overflow-hidden"
            src={`https://portfolios-self.vercel.app/example-project.jpg`}
        ...
        <div class="flex items-center gap-[68px]">
          <h1 class="text-[20px] font-bold">Todolist</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
      ...
      <div class="flex flex-col gap-[10px] items-left">
        ...
        <div class="flex items-center gap-[61px]">
          <h1 class="text-[20px] font-bold">Chat App</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
          <div className="flex items-center justify-center gap-[15px]">
            <a
              target="_blank"
      ...
      <div class="flex flex-col gap-[10px] items-left">
        ...
        <div class="flex items-center gap-[10px]">
          <h1 class="text-[20px] font-bold">Fortnite store(fake)</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
          <div className="flex items-center justify-center gap-[15px]">
            <a
              target="_blank"
      ...
      <div class="flex flex-col gap-[10px] items-left">
        ...
        <div class="flex items-center gap-[58px]">
          <h1 class="text-[20px] font-bold">Serial App</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
          <div className="flex items-center justify-center gap-[15px]">
            <a target="_blank" href="https://github.com/shoxruhGIT/my-app.git">
              {" "}
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <a target="_blank" href="https://movies-we.netlify.app/">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
      ...
      <div class="flex flex-col gap-[10px] items-left">
        ...
        <div class="flex items-center gap-[18px]">
          <h1 class="text-[20px] font-bold">E-commercial site</h1>
          <div class="w-[90px] h-[1px] bg-[#737374] opacity-[3]"></div>
          <div className="flex items-center justify-center gap-[15px]">
            <a
              target="_blank"
            ...
            <a target="_blank" href="https://product-menus.netlify.app/">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
