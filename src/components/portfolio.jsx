...
const Portfolio = () => {
  return (
    <div id="portfolio" className=" max-w-[1480px] m-auto pt-[170px] flex flex-col items-center gap-[50px] pb-[30px]">
      <h1 className="flex items-center gap-[15px] text-[34px] font-bold">
        <i class="fa-solid fa-briefcase text-blue-500"></i>Portfolio
      </h1>
      <div className="portfolio gap-[25px] pb-[20px]">
        <div className="flex flex-col gap-[10px] items-left">
          ...
          <p className="text-left text-[18px] w-[400px] font-normal">
            ...
            <b> themealdb.com</b> for food. You can easily order food on the
            site. Of course this site is fake.
          </p>
        </div>
        <div className="flex flex-col gap-[10px] items-left justify-center">
          ...
          <p className="text-left text-[18px] w-[400px] font-normal">
            To jot down tasks or activities you need to do. You can save not
            only your activities, but also your favorite movies, music, and the
            like.
          </p>
        </div>
        <div className="flex flex-col gap-[10px] items-left">
          ...
          <p className="text-left text-[18px] w-[400px] font-normal">
            ...
            users can reply to your tweets and you can reply to their reply
            tweets
          </p>
        </div>
        <div className="flex flex-col gap-[10px] items-left">
